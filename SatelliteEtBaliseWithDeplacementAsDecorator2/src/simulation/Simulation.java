...
public class Simulation {
	...
	public void launch() {
		...
		this.addSatelitte(sky, 100000, new Point(10,50), 2, "Sat 1");
		this.addSatelitte(sky, 100000, new Point(100,10), 1, "Sat 2");
		this.addSatelitte(sky, 100000, new Point(400,90), 3, "Sat 3");
		this.addSatelitte(sky, 100000, new Point(500,140), 4, "Sat 4");
		this.addSatelitte(sky, 100000, new Point(600,10), 1, "Sat 5");
